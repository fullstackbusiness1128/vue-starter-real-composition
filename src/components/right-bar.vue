...
export default {
  ...
  methods: {
    ...mapActions(layout, ['changeLayoutType', "changeLayoutWidth", 'changeTopbar',
      'changePosition', 'changeSidebarView', 'changeSidebarColor', 'changeMode']),
    hide() {
  ...
  computed: {
    ...mapState(layout, ['layoutType', 'layoutWidth', 'sidebarSize', 'topbar', 'position',
      'sidebarView', 'sidebarColor', 'mode'
    ]),
    layoutType: {
      get() {
    ...
    sidebarSize: {
      ...
      set(type) {
        return this.changeSidebarSize(type);
      },
    },
    position: {
      get() {
    ...
    sidebarView: {
      ...
      set(sidebarView) {
        return this.changeSidebarView(sidebarView);
      },
    },
    sidebarColor: {
      get() {
      ...
      set(sidebarColor) {
        return this.changeSidebarColor(sidebarColor);
      },
    },
    mode: {
      get() {
